...
# calculate_parity is not called (missing parentheses and argument)
# parity stores the function itself instead of the result
...
# loop iterates over characters instead of numbers
# i * 2 repeats strings instead of multiplying numbers
...
# calculate_area prints the result instead of returning it
# area becomes None because function does not return a value
...
# condition age < 0 and age > 120 can never be true at the same time
# should use OR instead of AND
# final output does not add increment to age
